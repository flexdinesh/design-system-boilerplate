...
> You can **server render themes** with zero runtime concerns. This page is server rendered with light theme. Try reloading the page after disabling JavaScript and you'll see the server rendered theme in action.
